...
for file in os.listdir(inputPath):
    if file.endswith(".html"):
        ...
        for row in rows:
            ...
            if len(cells) > 0:
                worksheet['A' + str(curRow)] = cells[0].text
                worksheet['B' + str(curRow)] = "Notice of Recent Bankruptcy Filing\n\nDetails: " + case_number + " " + name + "Case type: " + case_type + " Chapter: " + chapter + " Asset: " + asset + " Vol: " + vol + " Judge: " + judge + "\nDate filed: " + date_filed + " Date of last filing: " + date_of_last_filing
                #output += cells[0].text + "\n\nNotice of Recent Bankruptcy Filing\n\nDetails:\n\n" + case_number + " " + name + "\nCase type: " + case_type + " Chapter: " + chapter + " Asset: " + asset + " Vol: " + vol + " Judge: " + judge + "\nDate filed: " + date_filed + " Date of last filing: " + date_of_last_filing
            else:
                worksheet['A' + str(curRow)] = "No creditors"
            curRow += 1
        #data.write(output)
        #counter += 1
wb.save('excl.xls')
